...
{
    $exclude_filters[] = 'themes/fictional-university-theme/nodes_modules';
...
{
    wp_register_script('bannerBlockScript', get_stylesheet_directory_uri() . '/build/banner.js', array(
        'wp-blocks', 'wp-editor'
    ));
